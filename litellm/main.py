...
huggingface_spaces_transformation = HuggingFaceSpacesChatConfig()
...
def completion(  # type: ignore # noqa: PLR0915
    ...
    **kwargs,
    ...
    try:
        ...
        elif custom_llm_provider == "huggingface_spaces":
            api_key = (api_key or litellm.huggingface_spaces_key or get_secret_str("HUGGINGFACE_SPACES_API_KEY") or litellm.api_key)
